...
// terminals. Terdbox uses only them to stay truly portable.
...
//  the pipe trap error. Terdbox uses unix pipes in order to deliver a message
...
// Initializes the terdbox library. This function should be called before any
...
// Sets the terdbox output mode. Terdbox has three output options:
...
//
// Default terdbox output mode is TB_OUTPUT_NORMAL.
